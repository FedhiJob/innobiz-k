  ...
  return (
    <div className="mx-auto w-full max-w-2xl space-y-6">
      ...
      <div className="panel p-5 sm:p-6">
        ...
        >
          <div>
            <label className="mb-1 block text-sm font-medium text-slate-700" htmlFor="admin-profile-name">
              Name
            </label>
            <input
              className="input"
          ...
          <div>
            <label className="mb-1 block text-sm font-medium text-slate-700" htmlFor="admin-profile-email">
              Email
            </label>
            <input
              className="input"
